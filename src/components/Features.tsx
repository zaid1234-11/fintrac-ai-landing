  ...
  return (
    <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-primary/10 rounded-full blur-3xl animate-pulse md:w-96 md:h-96" />
        <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-accent/10 rounded-full blur-3xl animate-pulse [animation-delay:1s] md:w-96 md:h-96" />
      </div>

      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16 space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <div className="flex items-center justify-center gap-2 mb-4">
            <Sparkles className="w-5 h-5 md:w-6 md:h-6 text-primary animate-pulse" />
            <span className="text-xs md:text-sm font-semibold text-primary uppercase tracking-wider">Features</span>
            <Sparkles className="w-5 h-5 md:w-6 md:h-6 text-accent animate-pulse [animation-delay:0.5s]" />
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          {features.map((feature, index) => (
            <Card
              key={index}
              className={`group relative overflow-hidden bg-gradient-to-br ${feature.gradient} backdrop-blur-2xl border-white/10 shadow-xl hover:shadow-2xl transition-all duration-500 animate-in fade-in-up`}
            ...
            >
              ...
              <CardContent className="relative p-6 md:p-8 space-y-4 md:space-y-6">
                {/* Icon Container with Gradient */}
                <div className="relative">
                  <div className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br ${feature.iconBg} flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                ...
                <div className="space-y-2 md:space-y-3">
                  <h3 className="text-lg md:text-xl font-bold text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-slate-200 group-hover:bg-clip-text transition-all duration-300">
                    {feature.title}
                  </h3>
                ...
                <div className="flex items-center gap-2 text-xs md:text-sm font-medium text-primary opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
        ...
        {/* Bottom CTA Section */}
        <div className="text-center mt-12 md:mt-16 animate-in fade-in slide-in-from-bottom-4 duration-1000 [animation-delay:600ms]">
          <div className="inline-flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 rounded-full bg-gradient-to-r from-primary/10 to-accent/10 backdrop-blur-sm border border-primary/20">
            <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-primary animate-pulse" />
            <span className="text-xs md:text-base text-slate-200 font-medium">
              And many more features to discover
            </span>
            <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-accent animate-pulse [animation-delay:0.5s]" />
          </div>
        </div>
      </div>
    </section>
